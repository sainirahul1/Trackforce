              ...
              {activeSection === 'Storage' && analytics && (
                <div className="space-y-10 animate-in fade-in duration-500">
                  ...
                  <div className="bg-gray-900 rounded-[2rem] p-6 text-white shadow-2xl relative overflow-hidden border border-gray-800">
                    ...
                    <div className="relative z-10 flex flex-col gap-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-6 border-t border-gray-800/50">
                        {[1, 2, 3].map(i => (
                          <div key={i} className="p-4 rounded-xl bg-gray-800/30 border border-gray-700/30 text-center">
                            {loading ? (
                              ...
                              <>
                                <p className="text-[8px] font-black uppercase tracking-widest text-gray-500 mb-1">
                                  {i === 1 ? 'Remaining' : i === 2 ? 'Integrity' : 'IO Status'}
                                </p>
                                <p className={`text-${i === 1 ? 'xl text-indigo-400' : i === 2 ? 'sm text-emerald-400 flex items-center justify-center gap-1.5' : 'sm text-amber-500'} font-black uppercase tracking-tighter`}>
                                  {i === 1 ? `${analytics.storageMetrics.remaining}GB` : i === 2 ? <><Zap size={14} /> Healthy</> : 'Optimal'}
                                </p>
                              </>
                            )}
                          </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {[
                      { label: 'Total Database Objects', value: analytics ? (analytics.counts.users.total + analytics.counts.auditLogs) : 0, icon: Database, color: 'indigo' },
                      { label: 'Cloud Network Uptime', value: analytics ? analytics.uptime : '0%', icon: Cpu, color: 'amber' },
                    ].map((stat, i) => (
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-800/30 p-8 rounded-[2.5rem] border border-gray-100 dark:border-gray-800">
                      ...
                      <div className="flex justify-center gap-6 mt-4">
                        {loading ? (
                          [1, 2, 3].map(i => <Skeleton key={i} className="h-2 w-16" />)
                        ) : (
                          [
