  ...
  if (loading || !stats) {
    return (
      <div className="space-y-8 animate-in fade-in duration-700 pb-12">
        ...
        {/* 2. & 3. SKELETON SUBSCRIPTION & USAGE */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Subscription Detail Skeleton */}
          ...
          {/* Managed Personnel Usage Skeleton */}
          <div className="bg-white dark:bg-gray-800 rounded-[2rem] border-2 border-blue-500/10 p-6 shadow-sm">
        ...
        {/* REFINED SPLIT LAYOUT SKELETON */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          {/* LEFT COLUMN: MANAGER STRATEGIC COMMAND SKELETON */}
          <div className="lg:col-span-8 space-y-5">
            ...
            <div className="flex flex-col gap-4 min-h-[400px]">
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="bg-white dark:bg-gray-800 rounded-full border-2 border-blue-500/10 p-4 pl-6 pr-8 shadow-sm flex items-center justify-between gap-6">
          ...
          {/* RIGHT COLUMN: RECENT OPERATIONS SKELETON */}
              ...
              <div className="space-y-7">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="relative pl-7 space-y-2">
                     <div className="absolute left-0 top-1 w-2 h-2 rounded-full bg-gray-200 dark:bg-gray-700"></div>
