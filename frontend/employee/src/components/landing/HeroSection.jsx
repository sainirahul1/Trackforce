        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <div className="space-y-8 animate-in fade-in slide-in-from-left-8 duration-700">
            <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full bg-primary-main/5 dark:bg-primary-main/10 border border-primary-main/10 dark:border-primary-main/20">
              ...
              <span className="text-[10px] font-black text-primary-main uppercase tracking-widest">Employee App v2.4</span>
            </div>
            ...
            <p className="max-w-xl mx-auto lg:mx-0 text-lg md:text-xl text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
              A powerful mobile-first portal designed exclusively for field executives. 
              Manage tasks, log visits, submit orders, and track your daily performance seamlessly.
            </p>
            ...
            <div className="pt-8 flex items-center justify-center lg:justify-start space-x-8">
              <div className="text-center lg:text-left">
                ...
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Daily Visits</p>
              </div>
              <div className="w-px h-10 bg-gray-100 dark:bg-gray-800" />
              <div className="text-center lg:text-left">
                <p className="text-2xl font-black text-gray-900 dark:text-white">100%</p>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Reliability</p>
              </div>
              <div className="w-px h-10 bg-gray-100 dark:bg-gray-800" />
              <div className="text-center lg:text-left">
                <p className="text-2xl font-black text-gray-900 dark:text-white">1M+</p>
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Orders Submitted</p>
              </div>
            </div>
          </div>
          ...
          <div className="relative animate-in fade-in zoom-in duration-1000 delay-200">
            ...
            <div className="absolute -top-10 -right-10 z-20 bg-white dark:bg-gray-900 p-4 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 animate-bounce delay-500">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-xs font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Shift Status</p>
                  <p className="text-lg font-black text-gray-900 dark:text-white">On Duty</p>
                </div>
              </div>
            </div>
            ...
            <div className="absolute -bottom-10 -left-10 z-20 bg-white dark:bg-gray-900 p-4 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-800 animate-bounce">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-xs font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest">Tasks Done</p>
