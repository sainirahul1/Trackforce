...
const GlobalLoader = () => {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center bg-white/5 dark:bg-gray-950/5 backdrop-blur-[2px] transition-all duration-300">
      <div className="w-14 h-14 border-4 border-indigo-600 border-t-transparent rounded-full animate-spin shadow-xl"></div>
    </div>
  );
};
